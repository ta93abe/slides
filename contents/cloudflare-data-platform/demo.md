...
**スライド対応**: `data-platform.md`（Pipelines を Data Platform 構成要素として言及）
...
**スライド対応**: `data-platform.md` + `summary.md`（ベンダーロックインなし）
